...
@Log4j2
public class IncidentServerCloseIncidentTest {
    ...
    @Test
    public void sendMessageToKafkaAfterIncidentClosedAfterMinutes() throws InterruptedException, JsonProcessingException {
        ...
        IncidentKafka incidentKafkaPayload = new IncidentKafka();
        incidentKafkaPayload.setPayloadType("Incident");
        incidentKafkaPayload.setPayloadTypeCategory("IncidentStatusUpdated");
        incidentKafkaPayload.setPayload(incidentPayload);

        ObjectMapper objectMapper = new ObjectMapper().registerModule(new JavaTimeModule());
        String mqttPayloadJson = objectMapper.writeValueAsString(incidentKafkaPayload);
